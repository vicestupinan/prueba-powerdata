...
import co.com.vmestupinan.dynamodb.helper.TemplateAdapterOperations;
...
public class DynamoDBTemplateAdapter extends TemplateAdapterOperations<Stats, String, StatsEntity> implements StatsRepository {
    ...
    public DynamoDBTemplateAdapter(DynamoDbEnhancedAsyncClient connectionFactory, ObjectMapper mapper) {
         ...
         */
        super(connectionFactory, mapper, d -> mapper.mapBuilder(d, Stats.StatsBuilder.class).build(), "stats");
    }
